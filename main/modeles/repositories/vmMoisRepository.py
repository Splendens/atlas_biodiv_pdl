...
def getMonthlyObservationsChilds(connection, cd_ref):
    ...
    for inter in mesMois:
        return [
            {'mois': "Janvier", 'y': inter._01},
            {'mois': "Fevrier", 'y': inter._02},
            {'mois': "Mars", 'y': inter._03},
            {'mois': "Avril", 'y': inter._04},
            {'mois': "Mai", 'y': inter._05},
            {'mois': "Juin", 'y': inter._06},
            {'mois': "Juillet", 'y': inter._07},
            {'mois': "Aout", 'y': inter._08},
            {'mois': "Septembre", 'y': inter._09},
            {'mois': "Octobre", 'y': inter._10},
            {'mois': "Novembre", 'y': inter._11},
            {'mois': "Decembre", 'y': inter._12}
        ]
